            ...
            scope.variables.forEach((variable) => {
                ...
                variable.references.forEach((reference) => {
                    ...
                    if (((_a = node.parent) === null || _a === void 0 ? void 0 : _a.type) === utils_1.TSESTree.AST_NODE_TYPES.VariableDeclarator) {
                        ...
                        if (node.parent.init &&
                            (0, getFunction_1.isGetFunction)(node.parent.init) &&
                            !(0, getFunction_1.isGetOrNullObjectFunction)(node.parent.init)) {
                            getFound = true;
                            return;
                        }
                    }
                    if (((_b = node.parent) === null || _b === void 0 ? void 0 : _b.type) === utils_1.TSESTree.AST_NODE_TYPES.AssignmentExpression) {
                        ...
                        if ((0, getFunction_1.isGetFunction)(node.parent.right) &&
                            !(0, getFunction_1.isGetOrNullObjectFunction)(node.parent.right)) {
                            getFound = true;
                            return;
                        }
                    }

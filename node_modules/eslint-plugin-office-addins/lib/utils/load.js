...
function isLoadFunction(node) {
    var _a;
    node = (0, utils_2.findTopLevelExpression)(node);
    return (((_a = node.parent) === null || _a === void 0 ? void 0 : _a.type) === utils_1.AST_NODE_TYPES.CallExpression &&
        node.property.type === utils_1.TSESTree.AST_NODE_TYPES.Identifier &&
...
function parseLoadArguments(node) {
    ...
    if (isLoadFunction(node) &&
        ((_a = node.parent) === null || _a === void 0 ? void 0 : _a.type) === utils_1.TSESTree.AST_NODE_TYPES.CallExpression) {

...
function isContextSyncIdentifier(node) {
    ...
    return (node.name === "context" &&
        ...
        ((_c = (_b = node.parent) === null || _b === void 0 ? void 0 : _b.parent) === null || _c === void 0 ? void 0 : _c.type) === utils_1.AST_NODE_TYPES.CallExpression &&
        ((_d = node.parent) === null || _d === void 0 ? void 0 : _d.property.type) === utils_1.AST_NODE_TYPES.Identifier &&
